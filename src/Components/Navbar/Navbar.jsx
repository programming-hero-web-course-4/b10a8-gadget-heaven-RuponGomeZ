            ...
            <div className={location.pathname === '/' ? "navbar text-white " : "text-black navbar "}>
                ...
                <div className="navbar-end">
                    <div className="flex gap-3">
                        <Link to={'dashboard'} style={{ fontSize: '24px' }} className="hover:cursor-pointer border bg-white rounded-full text-black p-1">
                            <CiHeart />
                        </Link>
                        <Link to={'dashboard'} className="hover:cursor-pointer border bg-white rounded-full text-black p-1" style={{ fontSize: '24px' }}>
                            <TiShoppingCart />
                        </Link>
                    </div>
                </div>
